...
<head>
    ...
    <title>دعوة إفطار</title>
</head>

<body>
    <div class="m_-6780606299024699051body"
        style="min-width:100%;width:100%!important;background-color:#f8fafa;margin:0;padding:32px 0;font-family: Arial, Helvetica, sans-serif; direction: rtl;text-align: right">
                            ...
                            <tbody>
                                <tr style="padding:0">
                                    <td style="border-collapse:collapse!important;word-break:break-word;padding:24px 32px 30px"
                                        ...
                                        <p style="font-size:14px;padding-bottom:10px;margin:0">مرحبا
                                            {{ $user['name'] }},</p>

                                        <p style="font-size:14px;padding-bottom:10px;margin:0">أتشرف بدعوتك لحضور حفل
                                            الاشهار المرفق بالافطار على شرف الخطوبة الميمونة</p>

                                        <p style="font-size:14px;padding-bottom:10px;margin:0"><strong>اليوم:</strong>
                                            الاحد</p>

                                        <p style="font-size:14px;padding-bottom:10px;margin:0"><strong>التاريخ:</strong>
                                            8/3/2026</p>

                                        <p style="font-size:14px;padding-bottom:10px;margin:0"><strong>المكان:</strong>
                                            منزل السيد ابو كمال / الزيتون / بالقرب من مسجد الشمعة</p>
                                                            ...
                                                            <tbody>
                                                                <tr style="padding:0">
                                                                    <td
                                                                        ...
                                                                        <span>فائق الاحترام والتقدير ,</span><br>
                                                                        <span> حضوركم يزيد فرحتنا ,</span><br>
                                                                        <br>
