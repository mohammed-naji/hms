...
@section('content')
    <!-- Page Header-->
    <header class="masthead" style="background-image: url('{{ asset('blassets/assets/img/about-bg.jpg') }}')">
    ...
    <x-developer>
        <h2>About page Developer</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum tempore suscipit exercitationem magnam
            reiciendis eligendi sint sequi itaque in accusantium impedit officiis, error eveniet ut alias, saepe
            praesentium
